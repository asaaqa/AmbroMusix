...
from AmbroMusic.utils import help_pannel
from AmbroMusic.utils.database import get_lang, is_commanddelete_on
from AmbroMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from AmbroMusic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
@app.on_message(
    filters.command(["HELP_COMMAND"]) | filters.command(["ميوزك"],prefixes= ["/",""])
    & ~filters.edited
    & ~BANNED_USERS
)
