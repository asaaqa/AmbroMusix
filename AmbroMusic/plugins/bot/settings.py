...
from AmbroMusic.utils.database import (add_nonadmin_chat,
...
from AmbroMusic.utils.decorators.admins import ActualAdminCB
from AmbroMusic.utils.decorators.language import language, languageCB
from AmbroMusic.utils.inline.settings import (
    audio_quality_markup, auth_users_markup,
    cleanmode_settings_markup, playmode_users_markup, setting_markup,
    video_quality_markup)
from AmbroMusic.utils.inline.start import private_panel
...
@app.on_message(
    filters.command(["SETTINGS_COMMAND"]) | filters.command(["اعدادات","اعداد"],prefixes= ["/",""])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
