...
from AmbroMusic.utils.decorators.play import PlayWrapper
from AmbroMusic.utils.formatters import formats
from AmbroMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AmbroMusic.utils.inline.playlist import botplaylist_markup
from AmbroMusic.utils.logger import play_logs
from AmbroMusic.utils.stream.stream import stream
...
@app.on_message(
    filters.command(["PLAY_COMMAND"]) | filters.command(["شغل","ش","تشغيل"],prefixes= ["/",""])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
