...
from AmbroMusic.utils.database import set_cmode
from AmbroMusic.utils.decorators.admins import AdminActual
...
@app.on_message(
    filters.command(["CHANNELPLAY_COMMAND"]) | filters.command(["ق شغل","غني"],prefixes= ["/",""])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
