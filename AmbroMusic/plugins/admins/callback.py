...
from AmbroMusic.misc import SUDOERS, db
from AmbroMusic.utils.database import (is_active_chat,
                                       is_music_playing, is_muted,
                                       is_nonadmin_chat, music_off,
                                       music_on, mute_off, mute_on,
                                       set_loop)
from AmbroMusic.utils.decorators.language import languageCB
from AmbroMusic.utils.formatters import seconds_to_min
from AmbroMusic.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
from AmbroMusic.utils.stream.autoclear import auto_clean
from AmbroMusic.utils.thumbnails import gen_thumb
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Ambro.pause_stream(chat_id)
        ...
        await Ambro.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Ambro.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
