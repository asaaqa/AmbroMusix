...
from AmbroMusic.utils.database import get_lang, set_lang
from AmbroMusic.utils.decorators import (ActualAdminCB, language,
                                         languageCB)
...
@app.on_message(
    filters.command(["LANGUAGE_COMMAND"]) | filters.command(["اللغه","لغه"],prefixes= ["/",""])
    & filters.group
    & ~filters.edited
    & ~BANNED_USERS
)
